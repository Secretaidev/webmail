class CloakProvider {
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'cloak_0', domain: 'cloakmail.com', isActive: true, isPrivate: false },
      { id: 'cloak_1', domain: 'cloak.me', isActive: true, isPrivate: false },
      { id: 'cloak_2', domain: 'abyssmail.com', isActive: true, isPrivate: false },
      { id: 'cloak_3', domain: 'shieldedmail.com', isActive: true, isPrivate: false }
    ];
