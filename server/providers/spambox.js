class SpamBoxProvider {
  constructor() {
    this.name = 'spambox';
    this.displayName = 'SpamBox';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'spambox_0', domain: 'spambox.us', isActive: true, isPrivate: false },
      { id: 'spambox_1', domain: 'spambox.info', isActive: true, isPrivate: false },
      { id: 'spambox_2', domain: 'spambox.me', isActive: true, isPrivate: false },
      { id: 'spambox_3', domain: 'spambox.xyz', isActive: true, isPrivate: false }
    ];
...
module.exports = SpamBoxProvider;
