class EmlTmpProvider {
  constructor() {
    this.name = 'emltmp';
    this.displayName = 'EmlTmp';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'emltmp_0', domain: 'emltmp.com', isActive: true, isPrivate: false },
      { id: 'emltmp_1', domain: 'emlpro.com', isActive: true, isPrivate: false },
      { id: 'emltmp_2', domain: 'clrmail.com', isActive: true, isPrivate: false }
    ];
