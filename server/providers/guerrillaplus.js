/**
 * GuerrillaPlus - Extra Guerrilla domains
 */
const BASE_URL = 'https://api.guerrillamail.com/ajax.php';

class GuerrillaPlusProvider {
  constructor() {
    this.name = 'guerrillaplus';
    this.displayName = 'Guerrilla Plus';
    this.baseUrl = BASE_URL;
    this.cachedDomains = [
      { id: 'gp_0', domain: 'pookmail.com', isActive: true, isPrivate: false },
      { id: 'gp_1', domain: 'laste.ml', isActive: true, isPrivate: false },
      { id: 'gp_2', domain: 'ligsb.com', isActive: true, isPrivate: false },
      { id: 'gp_3', domain: 'motique.de', isActive: true, isPrivate: false },
    ];
  }
...
module.exports = GuerrillaPlusProvider;
