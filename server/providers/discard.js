class DiscardProvider {
  constructor() {
    this.name = 'discard';
    this.displayName = 'Discard.email';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'discard_0', domain: 'discard.email', isActive: true, isPrivate: false },
      { id: 'discard_1', domain: 'discardmail.com', isActive: true, isPrivate: false },
      { id: 'discard_2', domain: 'discardmail.de', isActive: true, isPrivate: false },
      { id: 'discard_3', domain: 'spam.su', isActive: true, isPrivate: false }
    ];
...
module.exports = DiscardProvider;
