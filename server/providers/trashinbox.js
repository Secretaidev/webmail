class TrashInboxProvider {
  constructor() {
    this.name = 'trashinbox';
    this.displayName = 'TrashInbox';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'trash_0', domain: 'trashinbox.com', isActive: true, isPrivate: false },
      { id: 'trash_1', domain: 'trashmail.io', isActive: true, isPrivate: false },
      { id: 'trash_2', domain: 'trashmail.ws', isActive: true, isPrivate: false },
      { id: 'trash_3', domain: 'trashmail.xyz', isActive: true, isPrivate: false },
      { id: 'trash_4', domain: 'trashinbox.net', isActive: true, isPrivate: false }
    ];
...
module.exports = TrashInboxProvider;
