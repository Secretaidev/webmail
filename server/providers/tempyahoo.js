/**
 * TempYahoo - Temporary Yahoo-style provider 
 * Uses Guerrilla Mail API backend
 * Domains: sharklasers.com, grr.la, spam4.me, guerrillamail.com
 */
const BASE_URL = 'https://api.guerrillamail.com/ajax.php';

class TempYahooProvider {
  constructor() {
    this.name = 'tempyahoo';
    this.displayName = 'TempYahoo';
    this.baseUrl = BASE_URL;
    this.cachedDomains = [
      { id: 'ty_0', domain: 'sharklasers.com', isActive: true, isPrivate: false },
      { id: 'ty_1', domain: 'grr.la', isActive: true, isPrivate: false },
      { id: 'ty_2', domain: 'spam4.me', isActive: true, isPrivate: false },
      { id: 'ty_3', domain: 'guerrillamail.com', isActive: true, isPrivate: false },
      { id: 'ty_4', domain: 'guerrillamail.de', isActive: true, isPrivate: false },
      { id: 'ty_5', domain: 'guerrillamail.net', isActive: true, isPrivate: false },
    ];
  }
  ...
  async createAccount(address) {
    try {
      ...
      const parts = address ? address.split('@') : [];
      const login = parts[0] || this._randomLogin();
      const domain = parts[1] || 'sharklasers.com';
...
module.exports = TempYahooProvider;
