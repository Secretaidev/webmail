class SpamgourmetProvider {
  constructor() {
    this.name = 'spamgourmet';
    this.displayName = 'Spamgourmet';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'spamgourmet_0', domain: 'spamgourmet.com', isActive: true, isPrivate: false },
      { id: 'spamgourmet_1', domain: 'spamgourmet.net', isActive: true, isPrivate: false },
      { id: 'spamgourmet_2', domain: 'spamgourmet.org', isActive: true, isPrivate: false }
    ];
...
module.exports = SpamgourmetProvider;
