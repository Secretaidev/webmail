/**
 * TempHotmail - Temporary Hotmail-style provider
 * Uses 1secMail API backend for reliable delivery
 * Domains: 1secmail.com, 1secmail.org, 1secmail.net
 */
const ONESEC_BASE = 'https://www.1secmail.com/api/v1/';

class TempHotmailProvider {
  constructor() {
    this.name = 'temphotmail';
    this.displayName = 'TempHotmail';
    this.baseUrl = ONESEC_BASE;
    this.cachedDomains = [
      { id: 'th_0', domain: '1secmail.com', isActive: true, isPrivate: false },
      { id: 'th_1', domain: '1secmail.org', isActive: true, isPrivate: false },
      { id: 'th_2', domain: '1secmail.net', isActive: true, isPrivate: false },
      { id: 'th_3', domain: 'wwjmp.com', isActive: true, isPrivate: false },
      { id: 'th_4', domain: 'esiix.com', isActive: true, isPrivate: false },
      { id: 'th_5', domain: 'xojxe.com', isActive: true, isPrivate: false },
      { id: 'th_6', domain: 'yoggm.com', isActive: true, isPrivate: false },
    ];
  }
...
module.exports = TempHotmailProvider;
