class MinuteMailProvider {
  constructor() {
    this.name = 'minutemail';
    this.displayName = 'MinuteMail';
  ...
  async getDomains() {
    this.cachedDomains = [
      { id: 'minute_0', domain: 'minutemail.com', isActive: true, isPrivate: false },
      { id: 'minute_1', domain: 'minutemailbox.com', isActive: true, isPrivate: false },
      { id: 'minute_2', domain: '5minutemail.com', isActive: true, isPrivate: false }
    ];
...
module.exports = MinuteMailProvider;
